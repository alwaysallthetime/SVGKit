...
void CGPathAddRoundedRectSVGKit (CGMutablePathRef path, CGRect rect, CGFloat radiusX, CGFloat radiusY);
...
- (void)postProcessAttributesAddingErrorsTo:(SVGKParseResult *)parseResult {
	...
	else
	{
		...
		CGPathAddRoundedRectSVGKit(path, rect, radiusXPixels, radiusYPixels);
	}
